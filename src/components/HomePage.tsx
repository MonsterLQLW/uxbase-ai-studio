  ...
  return (
    <div className="relative flex h-full min-h-0 flex-col items-center justify-center px-5 py-10 sm:px-8 sm:py-12">
      <div
        ...
        aria-hidden
      >
        <div className="absolute left-1/2 top-[38%] h-64 w-64 -translate-x-1/2 rounded-full bg-violet-600/30" />
        <div className="absolute left-1/2 top-[42%] h-48 w-48 translate-x-[min(12vw,6rem)] rounded-full bg-cyan-500/20" />
      </div>
